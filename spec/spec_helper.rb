...
RSpec.configure do |config|
  ...
  config.before :all do
    ...
    a = Administration::Activity.create("activity"=>"Trygforlæg", "collection"=>"billed", "availability"=>"0", "embargo"=>"0", "access_condition"=>"efter aftale", "preservation_profile"=>"storage", "copyright"=>"Attribution-ShareAlike CC BY-SA", "activity_permissions"=>{"instance"=>{"group"=>{"discover"=>["Chronos-Alle"], "read"=>["Chronos-NSA"], "edit"=>["Chronos-Pligtaflevering","Chronos-Admin"]}}, "file"=>{"group"=>{"discover"=>["Chronos-NSA"], "read"=>["Chronos-Pligtaflevering"], "edit"=>["Chronos-Admin"]}}})
