...
workers = ['sync_ext_repo','add_adl_images','fits_characterizing','dissemination','receive_preservation_response','import_from_preservation','send_to_preservation','validate_adl_tei_instance','letter_book_scan','letter_book_ingest']
