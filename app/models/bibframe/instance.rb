module Bibframe
  ...
  module Instance
    ...
    included do
      ...
      has_attributes :copyright_date, :published_date, :publisher_name, :isbn13, :isbn10, :system_number, :mode_of_issuance,
                     :title_statement, :published_place, :contents_note, :extent, :dimensions,
